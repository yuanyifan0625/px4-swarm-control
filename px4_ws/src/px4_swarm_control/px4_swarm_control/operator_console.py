...
def _help_text() -> str:
    return (
        ...
        '  x: move leader Gazebo ENU -X (West) step\n'
        '  3: move leader Gazebo ENU +Y (North) step\n'
        '  y: move leader Gazebo ENU -Y (South) step\n'
        '  4: move leader up by altitude step\n'
        '  z: move leader down by altitude step\n'
